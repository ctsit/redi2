...
<head>
	...
	<?php if (PAGE == 'DataEntry/index.php') { ?>
		<link rel="stylesheet" type="text/css" href="<?php echo APP_PATH_CSS ?>survey_text_very_large.css"
		      media="screen and (max-width: 767px)"><?php } ?>
	...
	<script type="text/javascript" charset="utf8"
	        src="<?php echo APP_PATH_WEBROOT_FULL ?>plugins/includes/js/datatables/media/js/jquery.dataTables.min.js"></script>
	<script type="text/javascript" charset="utf8"
	        src="<?php echo APP_PATH_WEBROOT_FULL ?>plugins/includes/js/datatables/extensions/FixedHeader/js/dataTables.fixedHeader.nightly.min.js"></script>
	<!-- Pace -->
	<!--	<script type="text/javascript"
	        src="<?php /*echo APP_PATH_WEBROOT_FULL */ ?>plugins/includes/js/pace/pace.min.js"></script>
	<link rel="stylesheet" type="text/css"
	      href="<?php /*echo APP_PATH_WEBROOT_FULL */ ?>plugins/includes/js/pace/pace-bounce.css"/>-->
</head>
<body>
<noscript>
	<div class="red" style="margin-top:50px;">
		...
		<a href="http://www.google.com/support/bin/answer.py?answer=23852" target="_blank"
		   style="text-decoration:underline;">clicking here</a>.
...
if ($date_deleted != "") {
	...
	<script type="text/javascript">
		function openDelProjDialog() {
			...
			$('#deleted_note').dialog({
				bgiframe: true, modal: true, width: 500, close: function () {
					setTimeout('openDelProjDialog()', 10);
				}
			});
		}
		$(function () {
	...
	<div class="container">
		<div class="navbar-header">
			<span class="navbar-brand"
			      style="max-width:80%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;"><?php echo filter_tags($app_title) ?></span>
